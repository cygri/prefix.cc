      <h2 class="expansion">
        ...
        <a class="namespace-link" href="<?php e($uri . $reference); ?>" rel="nofollow"><img src="images/link.png" alt="link to <?php echo $reference ? 'term' : 'namespace'; ?> URI" title="go to the <?php echo $reference ? 'term' : 'namespace'; ?> URI" /></a>
